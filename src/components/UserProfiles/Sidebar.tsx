...
export default function Sidebar({
	...
	const [shareToastContent, setShareToastContent] = useState<String | undefined>(undefined);
	...
	return (
		<div className="w-1/4 flex flex-col bg-bg-base-200 p-4 grow shrink basis-auto ">
			...
			{userProfile.visibility == "PUBLIC" ? (
				...
				<p>
					This profile is private. Only you, the owner, can view it. Change your profile visibility
					in the edit profile page if you want to share it with others.
				</p>
			)}
			{shareToastContent && (
				<div className="bg-base-200 text-primary p-2 rounded-md mt-1">{shareToastContent}</div>
			)}
